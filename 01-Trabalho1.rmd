...
As probabilidades de sobrevivência anuais, podem ser expressas na tabela abaixo.

```{r}
m <- matrix(c(0.91,0.83,0.78,0.67,0.60), ncol = 5)

colnames(m) <- c("1 year", "2 years", "3 years", "4 years", "5 years")

surv_times <- as_tibble(m)
...
if (FALSE) { #set to TRUE to save the results in a pdf
